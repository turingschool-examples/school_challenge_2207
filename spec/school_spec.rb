...
RSpec.describe 'School Spec Harness' do
  ...
  describe '#is full time?' do
    it 'determines if the school is full time' do
      expect(@school1.is_full_time?).to be true
    end
  end

  describe '@standard student names' do
    it 'has an array of student names capitialized' do
      @school1.add_student_name('Aurora')
      @school1.add_student_name('tim')
      @school1.add_student_name('megan')
  ...
  describe '#convert_end_time_to_clock_time' do
    it 'converts end time to clock time' do
